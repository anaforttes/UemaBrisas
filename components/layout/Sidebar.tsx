    ...
    <aside className="w-72 bg-white border-r border-slate-200 h-screen flex flex-col sticky top-0 z-20">
      ...
      <div className="mt-auto p-8 border-t border-slate-50 space-y-6">
        ...
        <div className="space-y-1">
          <button
            onClick={onLogout}
            className="flex items-center gap-3 px-5 py-3 text-red-500 hover:bg-red-50 hover:text-red-700 transition-all rounded-xl w-full text-left font-bold text-sm"
          >
            <LogOut size={20} />
