      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-2">
        ...
        {abaAtiva === 'versoes' && (
          <>
            ...
            {versoes.map((versao) => (
              <div key={versao.id} className="border border-slate-100 rounded-xl overflow-hidden">
                <div
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span
                        className={`text-[9px] font-black px-2 py-0.5 rounded-full uppercase ${estilo.cor}`}
                      >
                        {estilo.label}
                      </span>
